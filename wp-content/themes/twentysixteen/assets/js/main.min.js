...
!function(e,n,t){function r(e,n){return typeof e===n}function o(){var e,n,t,o,s,i,a;for(var f in C)if(C.hasOwnProperty(f)){if(e=[],n=C[f],n.name&&(e.push(n.name.toLowerCase()),n.options&&n.options.aliases&&n.options.aliases.length))for(t=0;t<n.options.aliases.length;t++)e.push(n.options.aliases[t].toLowerCase());for(o=r(n.fn,"function")?n.fn():n.fn,s=0;s<e.length;s++)i=e[s],a=i.split("."),1===a.length?S[a[0]]=o:(!S[a[0]]||S[a[0]]instanceof Boolean||(S[a[0]]=new Boolean(S[a[0]])),S[a[0]][a[1]]=o),y.push((o?"":"no-")+a.join("-"))}}function s(e){var n=b.className,t=S._config.classPrefix||"";if(T&&(n=n.baseVal),S._config.enableJSClass){var r=new RegExp("(^|\\s)"+t+"no-js(\\s|$)");n=n.replace(r,"$1"+t+"js$2")}S._config.enableClasses&&(n+=" "+t+e.join(" "+t),T?b.className.baseVal=n:b.className=n)}function i(){return"function"!=typeof n.createElement?n.createElement(arguments[0]):T?n.createElementNS.call(n,"http://www.w3.org/2000/svg",arguments[0]):n.createElement.apply(n,arguments)}function a(){var e=n.body;return e||(e=i(T?"svg":"body"),e.fake=!0),e}function f(e,t,r,o){var s,f,u,l,d="modernizr",p=i("div"),c=a();if(parseInt(r,10))for(;r--;)u=i("div"),u.id=o?o[r]:d+(r+1),p.appendChild(u);return s=i("style"),s.type="text/css",s.id="s"+d,(c.fake?c:p).appendChild(s),c.appendChild(p),s.styleSheet?s.styleSheet.cssText=e:s.appendChild(n.createTextNode(e)),p.id=d,c.fake&&(c.style.background="",c.style.overflow="hidden",l=b.style.overflow,b.style.overflow="hidden",b.appendChild(c)),f=t(p,e),c.fake?(c.parentNode.removeChild(c),b.style.overflow=l,b.offsetHeight):p.parentNode.removeChild(p),!!f}function u(e,n){return!!~(""+e).indexOf(n)}function l(e){return e.replace(/([a-z])-([a-z])/g,function(e,n,t){return n+t.toUpperCase()}).replace(/^-/,"")}function d(e,n){return function(){return e.apply(n,arguments)}}function p(e,n,t){var o;for(var s in e)if(e[s]in n)return t===!1?e[s]:(o=n[e[s]],r(o,"function")?d(o,t||n):o);return!1}function c(e){return e.replace(/([A-Z])/g,function(e,n){return"-"+n.toLowerCase()}).replace(/^ms-/,"-ms-")}function m(n,r){var o=n.length;if("CSS"in e&&"supports"in e.CSS){for(;o--;)if(e.CSS.supports(c(n[o]),r))return!0;return!1}if("CSSSupportsRule"in e){for(var s=[];o--;)s.push("("+c(n[o])+":"+r+")");return s=s.join(" or "),f("@supports ("+s+") { #modernizr { position: absolute; } }",function(e){return"absolute"==getComputedStyle(e,null).position})}return t}function h(e,n,o,s){function a(){d&&(delete q.style,delete q.modElem)}if(s=!r(s,"undefined")&&s,!r(o,"undefined")){var f=m(e,o);if(!r(f,"undefined"))return f}for(var d,p,c,h,v,g=["modernizr","tspan","samp"];!q.style&&g.length;)d=!0,q.modElem=i(g.shift()),q.style=q.modElem.style;for(c=e.length,p=0;c>p;p++)if(h=e[p],v=q.style[h],u(h,"-")&&(h=l(h)),q.style[h]!==t){if(s||r(o,"undefined"))return a(),"pfx"!=n||h;try{q.style[h]=o}catch(e){}if(q.style[h]!=v)return a(),"pfx"!=n||h}return a(),!1}function v(e,n,t,o,s){var i=e.charAt(0).toUpperCase()+e.slice(1),a=(e+" "+A.join(i+" ")+i).split(" ");return r(n,"string")||r(n,"undefined")?h(a,n,o,s):(a=(e+" "+z.join(i+" ")+i).split(" "),p(a,n,t))}function g(e,n,r){return v(e,t,t,n,r)}var y=[],C=[],w={_version:"3.3.1",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(e,n){var t=this;setTimeout(function(){n(t[e])},0)},addTest:function(e,n,t){C.push({name:e,fn:n,options:t})},addAsyncTest:function(e){C.push({name:null,fn:e})}},S=function(){};S.prototype=w,S=new S;var x=w._config.usePrefixes?" -webkit- -moz- -o- -ms- ".split(" "):["",""];w._prefixes=x;var b=n.documentElement,T="svg"===b.nodeName.toLowerCase(),_="Moz O ms Webkit",z=w._config.usePrefixes?_.toLowerCase().split(" "):[];w._domPrefixes=z;var P="CSS"in e&&"supports"in e.CSS,j="supportsCSS"in e;S.addTest("supports",P||j),S.addTest("inlinesvg",function(){var e=i("div");return e.innerHTML="<svg/>","http://www.w3.org/2000/svg"==("undefined"!=typeof SVGRect&&e.firstChild&&e.firstChild.namespaceURI)});var k=function(){var n=e.matchMedia||e.msMatchMedia;return n?function(e){var t=n(e);return t&&t.matches||!1}:function(n){var t=!1;return f("@media "+n+" { #modernizr { position: absolute; } }",function(n){t="absolute"==(e.getComputedStyle?e.getComputedStyle(n,null):n.currentStyle).position}),t}}();w.mq=k,S.addTest("mediaqueries",k("only all"));var E=w.testStyles=f;S.addTest("touchevents",function(){var t;if("ontouchstart"in e||e.DocumentTouch&&n instanceof DocumentTouch)t=!0;else{var r=["@media (",x.join("touch-enabled),("),"heartz",")","{#modernizr{top:9px;position:absolute}}"].join("");E(r,function(e){t=9===e.offsetTop})}return t});var A=w._config.usePrefixes?_.split(" "):[];w._cssomPrefixes=A;var N={elem:i("modernizr")};S._q.push(function(){delete N.elem});var q={style:N.elem.style};S._q.unshift(function(){delete q.style}),w.testAllProps=v,w.testAllProps=g,S.addTest("csstransforms",function(){return-1===navigator.userAgent.indexOf("Android 2.")&&g("transform","scale(1)",!0)}),S.addTest("csstransforms3d",function(){var e=!!g("perspective","1px",!0),n=S._config.usePrefixes;if(e&&(!n||"webkitPerspective"in b.style)){var t,r="#modernizr{width:0;height:0}";S.supports?t="@supports (perspective: 1px)":(t="@media (transform-3d)",n&&(t+=",(-webkit-transform-3d)")),t+="{#modernizr{width:7px;height:18px;margin:0;padding:0;border:0}}",E(r+t,function(n){e=7===n.offsetWidth&&18===n.offsetHeight})}return e}),o(),s(y),delete w.addTest,delete w.addAsyncTest;for(var L=0;L<S._q.length;L++)S._q[L]();e.Modernizr=S}(window,document);
...
window.init=function(){"use strict";window.propCore={};var o,r={},n=function(o,r){var n=o.split("__");return r===!0?n=n[0]:n.shift(),n},i=function(o,r){for(var i=n(r,!0),e=0,a=o.length;e<a;e++)try{if(propCore[i]=new propFuncs[r],"scroll"===o[e]||"resize"===o[e]){var t=o[e];$(window).on(o[e],function(o){var r=o;window.requestAnimationFrame?window.requestAnimationFrame(function(){propCore[i][t](r)}):propCore[i][t](r)})}}catch(o){console.groupCollapsed&&console.groupCollapsed("%c ["+r+" error] - "+o.message+". Expand for details:","color: #ff5a5a").info("%c "+o.stack,"color: #ff5a5a").groupEnd()}};for(o in window.propFuncs){var e=n(o,!0);r[e]=n(o),i(r[e],o)}};
window.propFuncs={createMap__ready:function(){var e=this;e.init=function(){if(document.getElementById("google-map")){var e=$("#google-map"),a={zoom:e.data("zoom"),mapTypeId:google.maps.MapTypeId.ROADMAP,panControl:!1,zoomControl:!0,scaleControl:!1,mapTypeControl:!1,streetViewControl:!1,scrollwheel:!1,draggable:!0},o=new google.maps.Map(document.getElementById("google-map"),a),n=new google.maps.MarkerImage("/assets/img/map-icon.png",new google.maps.Size(64,72),new google.maps.Point(0,0),new google.maps.Point(32,72)),t=new google.maps.LatLngBounds,g={1:[51.5092431,-.1371313]};for(var i in g){var l=new google.maps.LatLng(g[i][0],g[i][1]);new google.maps.Marker({position:l,map:o,icon:n,animation:google.maps.Animation.DROP});t.extend(l)}var r=t.getCenter();o.setCenter(r)}}},mapScript__ready:function(){if(document.getElementById("google-map")){var e=document.createElement("script");e.type="text/javascript",e.src="https://maps.googleapis.com/maps/api/js?v=3.exp&callback=propCore.createMap.init",document.body.appendChild(e)}},navTrigger__ready:function(){$(".js-nav-trigger").on("click",function(e){e.preventDefault(),$(".js-nav").toggleClass("is-active"),$(this).toggleClass("is-active")})},flkty__ready:function(){new Flickity(".main-carousel",{wrapAround:!0,contain:!0,autoPlay:1e4,cellAlign:"left",arrowShape:"M48 64 L16 32 L48 0 L48 2 L18 32 L48 62 Z"})},imager__ready:function(){window.imager=new Imager(".js-imager",{lazyload:!0,lazyloadOffset:100,onImagesReplaced:function(e){$(".image-replace").addClass("visible")}})}};
