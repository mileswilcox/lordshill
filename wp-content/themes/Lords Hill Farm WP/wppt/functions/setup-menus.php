<?php
/**
 * Register Navigation Menu wordpress documentation on function use:
...
function register_menus() {
    register_nav_menus( array(
        'primary' => __('Primary Navigation', 'wppt')
    ));
}
 ...
 */
class wp_walker_nav extends Walker_Nav_Menu {
    ...
    public function start_lvl( &$output, $depth = 0, $args = array() ) {
        ...
        $list_classes_str = PROP_BEM::get_bem( $args->menu_class, $list_classes );
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        // BEM-ify the given sub classes
        $item_classes_str = PROP_BEM::get_bem( $args->menu_class, $item_classes );
        ...
        $output .= $args->before;
        $output .= PROP_Html::get_element( $tag, $attrs, $link_content );
        $output .= $args->after;
    }
