...
window.init=function(){"use strict";window.propCore={};var o,r={},n=function(o,r){var n=o.split("__");return r===!0?n=n[0]:n.shift(),n},i=function(o,r){for(var i=n(r,!0),e=0,a=o.length;a>e;e++)try{if(propCore[i]=new propFuncs[r],"scroll"===o[e]||"resize"===o[e]){var t=o[e];$(window).on(o[e],function(o){var r=o;window.requestAnimationFrame?window.requestAnimationFrame(function(){propCore[i][t](r)}):propCore[i][t](r)})}}catch(p){console.groupCollapsed&&console.groupCollapsed("%c ["+r+" error] - "+p.message+". Expand for details:","color: #ff5a5a").info("%c "+p.stack,"color: #ff5a5a").groupEnd()}};for(o in window.propFuncs){var e=n(o,!0);r[e]=n(o),i(r[e],o)}};
